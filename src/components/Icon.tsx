...
import { type ComponentProps, ForwardedRef, forwardRef, useMemo } from 'react';
...
function Icon({ name, className, invert, ...props }: IconProps, ref: ForwardedRef<SVGSVGElement>) {
  const {
