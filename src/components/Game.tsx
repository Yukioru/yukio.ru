  ...
  return (
    <div className="flex gap-3 sm:gap-3 items-start sm:items-center">
      <Image
        ...
        src={image}
        alt={title}
        className="rounded-lg bg-zinc-200/75 dark:bg-zinc-800/75 flex-shrink-0 border border-zinc-100 dark:border-zinc-800 select-none"
      />
      <div className="flex gap-2 sm:gap-3 items-start sm:items-center flex-col sm:flex-row grow">
        ...
        <div className="flex gap-1 items-center uppercase py-0.5 px-1 text-sm bg-zinc-200/75 dark:bg-zinc-800/75 rounded-lg sm:ml-auto">
